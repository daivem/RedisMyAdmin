...
<table>
	...
	<tr <?= $alt ? 'class="alt"' : ''?>>
		...
		<td><div> <a href="<?= manager_site_url('edit', 'index', 'key=' . urlencode($key) . '&type=' . $type . '&hkey=' .  urlencode($hkey)); ?>"><img src="<?= base_url('static/images/edit.png'); ?>" width="16" height="16" title="编辑" alt="编辑"></a> </div></td>
		<td><div> <a href="<?= manager_site_url('delete', 'index', 'key=' . urlencode($key) . '&type=' . $type . '&hkey=' .  urlencode($hkey)); ?>" class="delval"><img src="<?= base_url('static/images/delete.png'); ?>" width="16" height="16" title="删除" alt="删除"></a> </div></td>
	</tr>
	<?php 
	$alt = ! $alt;
}
...
<p> <a href="<?= manager_site_url('edit', 'index', 'key=' . urlencode($key) . '&type=' . $type ); ?>" class="add">新增一个值</a> </p><?php PagerWidget::footer(); ?>
