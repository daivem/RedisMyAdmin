...
<h2>
	...
	<a href="<?= manager_site_url('delete', 'index', 'key=' . urlencode($key)); ?>" class="delkey">
		<img src="<?= base_url('static/images/delete.png'); ?>" width="16" height="16" title="删除" alt="[X]" /></a>
...
<table>
	<tr>
		...
		<td>
			<div> 
				<a href="<?= manager_site_url('edit', 'index', 'key=' . urlencode($key) . '&type=string'); ?>">
		...
		<td>
			<div> 
				<a href="<?= manager_site_url('delete', 'index', 'key=' . urlencode($key) . '&type=string'); ?>" class="delval">
