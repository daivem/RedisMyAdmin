...
?>
	<tr <?= $alt ? 'class="alt"' : ''?>>
		...
		<td>
			<div> 
				<a href="<?= manager_site_url('edit', 'index', 'key=' . urlencode($key) . '&type=' . $type . '&index=' .  $i); ?>">
		...
		<td>
			<div> 
				<a href="<?= manager_site_url('delete', 'index', 'key=' . urlencode($key) . '&type=' . $type . '&index=' .  $i); ?>" class="delval">
