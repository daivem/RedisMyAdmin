...
<table>
	...
	<tr <?= $alt ? 'class="alt"' : ''?>>
		...
		<td>
			<div> 
				<a href="<?= manager_site_url('edit', 'index', 'key=' . urlencode($key) . '&type=' . $type . '&value=' .  $value . '&score=' . $score); ?>">
					<img src="<?= base_url('static/images/edit.png'); ?>" width="16" height="16" title="编辑" alt="编辑" />
				</a> 
				<a href="<?= manager_site_url('delete', 'index', 'key=' . urlencode($key) . '&type=' . $type . '&value=' .  $value . '&score=' . $score); ?>" class="delval">
